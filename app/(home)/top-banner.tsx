export default function TopBanner() {
  return (
    <div>
      <div className="bg-cover bg-center bg-main-top-banner rounded-2xl h-60 shadow-md min-w-[320px] md:h-[800px] md:rounded-[30px]">
        <div className="flex flex-col w-full h-full bg-gradient-to-r from-bg_gradient/75 rounded-[30px]">
